        ...
        <nav className="flex items-center space-x-6 relative">
          ...
          {dropdownOpen && (
            ...
            >
              ...
              {/* <button
                className="mt-4 block w-full bg-blue-500 text-white py-2 rounded-md text-center font-semibold hover:bg-blue-600"
              ...
              <button
                className="mt-2 block w-full bg-[#04bab1] text-white py-2 rounded-md text-center font-semibold hover:bg-red-600"
